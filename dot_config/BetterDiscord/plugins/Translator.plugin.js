...
module.exports = (_ => {
  ...
  return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
    ...
    return class Translator extends Plugin {
      ...
      onStart() {
        BDFDB.PatchUtils.patch(this, BDFDB.LibraryModules.MessageUtils, "startEditMessage", {
          before: e => {
        ...
        BDFDB.PatchUtils.patch(this, BDFDB.LibraryModules.MessageUtils, "editMessage", {
          before: e => {
      ...
      processChannelTextAreaContainer(e) {
        ...
        BDFDB.PatchUtils.patch(this, e.instance.props, "onSubmit", {
          instead: e2 => {
