...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUIAEvlConnection_QueryInterface(IUIAEvlConnection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUIAEvlConnection_AddRef(IUIAEvlConnection* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUIAEvlConnection_Release(IUIAEvlConnection* This) {
    return This->lpVtbl->Release(This);
}
/*** IUIAEvlConnection methods ***/
static __WIDL_INLINE HRESULT IUIAEvlConnection_ProviderRaiseEvent(IUIAEvlConnection* This,LONG event,IRawElementProviderSimple *pRetVal) {
    return This->lpVtbl->ProviderRaiseEvent(This,event,pRetVal);
}
static __WIDL_INLINE HRESULT IUIAEvlConnection_CheckListenerStatus(IUIAEvlConnection* This,VARIANT *val) {
...
static __WIDL_INLINE HRESULT ISelectionProvider2_get_CanSelectMultiple(ISelectionProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanSelectMultiple(This,pRetVal);
}
static __WIDL_INLINE HRESULT ISelectionProvider2_get_IsSelectionRequired(ISelectionProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_IsSelectionRequired(This,pRetVal);
}
/*** ISelectionProvider2 methods ***/
static __WIDL_INLINE HRESULT ISelectionProvider2_get_FirstSelectedItem(ISelectionProvider2* This,IRawElementProviderSimple **retVal) {
    return This->lpVtbl->get_FirstSelectedItem(This,retVal);
}
static __WIDL_INLINE HRESULT ISelectionProvider2_get_LastSelectedItem(ISelectionProvider2* This,IRawElementProviderSimple **retVal) {
    return This->lpVtbl->get_LastSelectedItem(This,retVal);
}
static __WIDL_INLINE HRESULT ISelectionProvider2_get_CurrentSelectedItem(ISelectionProvider2* This,IRawElementProviderSimple **retVal) {
    return This->lpVtbl->get_CurrentSelectedItem(This,retVal);
}
static __WIDL_INLINE HRESULT ISelectionProvider2_get_ItemCount(ISelectionProvider2* This,int *retVal) {
...
/*** IValueProvider methods ***/
static __WIDL_INLINE HRESULT IValueProvider_SetValue(IValueProvider* This,BSTR val) {
    return This->lpVtbl->SetValue(This,val);
}
